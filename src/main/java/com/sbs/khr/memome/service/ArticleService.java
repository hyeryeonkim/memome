...
public class ArticleService {
	...
	public int write(Map<String, Object> param) {
		...
		if ( board.getCode().equals("unicon")) {
			attrService.setValue("member", memberId, "extra", "usingUnicon", id + "", null);
				...
				for ( int i = 1; i <= 12; i++ ) {
					if ( (Integer)param.get("invite" + i) != null ) {
						System.out.println("email 뭐냐고오오오오");
						//emails.add((String) param.get("invite" + ( i + 1)));
